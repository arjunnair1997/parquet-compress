...
import (
	...
	"parquet_compress/parquet-go/compress/brotli"
	"parquet_compress/parquet-go/compress/gzip"
	"parquet_compress/parquet-go/compress/lz4"
	"parquet_compress/parquet-go/compress/snappy"
	"parquet_compress/parquet-go/compress/uncompressed"
