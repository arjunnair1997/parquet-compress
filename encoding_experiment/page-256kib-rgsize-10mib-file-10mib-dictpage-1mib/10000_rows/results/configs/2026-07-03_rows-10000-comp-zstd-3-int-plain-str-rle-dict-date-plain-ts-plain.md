...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4542719` (4.33 MiB)
- Compressed column data bytes after codec compression: `636536` (621.62 KiB)
- Parquet file bytes: `653186` (637.88 KiB)
- Physical/encoded ratio: `1.698x`
- Encoded/compressed-data ratio: `7.137x`
- Physical/compressed-data ratio: `12.115x`
- Physical/parquet-file ratio: `11.807x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `653186` file bytes (637.88 KiB), `7711890` physical bytes (7.35 MiB), `4542719` encoded bytes (4.33 MiB), `636536` compressed data bytes (621.62 KiB)
