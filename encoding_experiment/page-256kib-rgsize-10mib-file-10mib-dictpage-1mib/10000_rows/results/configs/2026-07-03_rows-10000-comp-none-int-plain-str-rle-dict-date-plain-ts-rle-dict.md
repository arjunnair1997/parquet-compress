...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4474887` (4.27 MiB)
- Compressed column data bytes after codec compression: `4474887` (4.27 MiB)
- Parquet file bytes: `4492109` (4.28 MiB)
- Physical/encoded ratio: `1.723x`
- Encoded/compressed-data ratio: `1.000x`
- Physical/compressed-data ratio: `1.723x`
- Physical/parquet-file ratio: `1.717x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-rle-dict/part-00000.parquet`: `10000` rows, `4492109` file bytes (4.28 MiB), `7711890` physical bytes (7.35 MiB), `4474887` encoded bytes (4.27 MiB), `4474887` compressed data bytes (4.27 MiB)
