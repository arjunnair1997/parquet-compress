...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4434910` (4.23 MiB)
- Compressed column data bytes after codec compression: `4434910` (4.23 MiB)
- Parquet file bytes: `4452139` (4.25 MiB)
- Physical/encoded ratio: `1.739x`
- Encoded/compressed-data ratio: `1.000x`
- Physical/compressed-data ratio: `1.739x`
- Physical/parquet-file ratio: `1.732x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict_columns.tsv)
...
| `Title` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `2200605` (2.10 MiB) | `545453` (532.67 KiB) | `545453` (532.67 KiB) | `4.034x` | `1.000x` | `4.034x` | `2200673` (2.10 MiB) |
...
| `URL` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `760012` (742.20 KiB) | `247077` (241.29 KiB) | `247077` (241.29 KiB) | `3.076x` | `1.000x` | `3.076x` | `760022` (742.21 KiB) |
| `Referer` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `797798` (779.10 KiB) | `233930` (228.45 KiB) | `233930` (228.45 KiB) | `3.410x` | `1.000x` | `3.410x` | `797822` (779.12 KiB) |
...
| `FlashMinor2` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `37170` (36.30 KiB) | `2794` (2.73 KiB) | `2794` (2.73 KiB) | `13.304x` | `1.000x` | `13.304x` | `37170` (36.30 KiB) |
...
| `UserAgentMinor` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `36930` (36.06 KiB) | `1986` (1.94 KiB) | `1986` (1.94 KiB) | `18.595x` | `1.000x` | `18.595x` | `37108` (36.24 KiB) |
...
| `MobilePhoneModel` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `1140` (1.11 KiB) | `216` (216 B) | `216` (216 B) | `5.278x` | `1.000x` | `5.278x` | `1140` (1.11 KiB) |
| `Params` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `0` (0 B) | `71` (71 B) | `71` (71 B) | `0.000x` | `1.000x` | `0.000x` | `0` (0 B) |
...
| `SearchPhrase` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `65246` (63.72 KiB) | `28477` (27.81 KiB) | `28477` (27.81 KiB) | `2.291x` | `1.000x` | `2.291x` | `65250` (63.72 KiB) |
...
| `PageCharset` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `196540` (191.93 KiB) | `280` (280 B) | `280` (280 B) | `701.929x` | `1.000x` | `701.929x` | `196540` (191.93 KiB) |
...
| `OriginalURL` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `74750` (73.00 KiB) | `32331` (31.57 KiB) | `32331` (31.57 KiB) | `2.312x` | `1.000x` | `2.312x` | `74750` (73.00 KiB) |
...
| `HitColor` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `10000` (9.77 KiB) | `121` (121 B) | `121` (121 B) | `82.645x` | `1.000x` | `82.645x` | `10000` (9.77 KiB) |
...
| `BrowserLanguage` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `20156` (19.68 KiB) | `431` (431 B) | `431` (431 B) | `46.766x` | `1.000x` | `46.766x` | `20156` (19.68 KiB) |
| `BrowserCountry` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `32430` (31.67 KiB) | `1096` (1.07 KiB) | `1096` (1.07 KiB) | `29.589x` | `1.000x` | `29.589x` | `38645` (37.74 KiB) |
| `SocialNetwork` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `0` (0 B) | `71` (71 B) | `71` (71 B) | `0.000x` | `1.000x` | `0.000x` | `0` (0 B) |
| `SocialAction` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `0` (0 B) | `71` (71 B) | `71` (71 B) | `0.000x` | `1.000x` | `0.000x` | `0` (0 B) |
...
| `SocialSourcePage` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `42` (42 B) | `102` (102 B) | `102` (102 B) | `0.412x` | `1.000x` | `0.412x` | `42` (42 B) |
...
| `ParamOrderID` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `0` (0 B) | `71` (71 B) | `71` (71 B) | `0.000x` | `1.000x` | `0.000x` | `0` (0 B) |
| `ParamCurrency` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `30000` (29.30 KiB) | `85` (85 B) | `85` (85 B) | `352.941x` | `1.000x` | `352.941x` | `30000` (29.30 KiB) |
...
| `OpenstatServiceName` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `560` (560 B) | `201` (201 B) | `201` (201 B) | `2.786x` | `1.000x` | `2.786x` | `560` (560 B) |
| `OpenstatCampaignID` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `272` (272 B) | `213` (213 B) | `213` (213 B) | `1.277x` | `1.000x` | `1.277x` | `272` (272 B) |
| `OpenstatAdID` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `358` (358 B) | `340` (340 B) | `340` (340 B) | `1.053x` | `1.000x` | `1.053x` | `358` (358 B) |
| `OpenstatSourceID` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `692` (692 B) | `250` (250 B) | `250` (250 B) | `2.768x` | `1.000x` | `2.768x` | `692` (692 B) |
| `UTMSource` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `1621` (1.58 KiB) | `509` (509 B) | `509` (509 B) | `3.185x` | `1.000x` | `3.185x` | `1621` (1.58 KiB) |
| `UTMMedium` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `502` (502 B) | `377` (377 B) | `377` (377 B) | `1.332x` | `1.000x` | `1.332x` | `502` (502 B) |
| `UTMCampaign` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `3304` (3.23 KiB) | `637` (637 B) | `637` (637 B) | `5.187x` | `1.000x` | `5.187x` | `3304` (3.23 KiB) |
| `UTMContent` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `474` (474 B) | `203` (203 B) | `203` (203 B) | `2.335x` | `1.000x` | `2.335x` | `474` (474 B) |
| `UTMTerm` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `1288` (1.26 KiB) | `288` (288 B) | `288` (288 B) | `4.472x` | `1.000x` | `4.472x` | `1288` (1.26 KiB) |
| `FromTag` | `string` | `rle-dict` | `PLAIN, RLE_DICTIONARY` | `DATA_PAGE_V2/RLE_DICTIONARY:1, DICTIONARY_PAGE/PLAIN:1` | `10000` | `0` (0 B) | `71` (71 B) | `71` (71 B) | `0.000x` | `1.000x` | `0.000x` | `0` (0 B) |
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict/part-00000.parquet`: `10000` rows, `4452139` file bytes (4.25 MiB), `7711890` physical bytes (7.35 MiB), `4434910` encoded bytes (4.23 MiB), `4434910` compressed data bytes (4.23 MiB)
