...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-plain-date-plain-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `8778991` (8.37 MiB)
- Compressed column data bytes after codec compression: `806438` (787.54 KiB)
- Parquet file bytes: `823409` (804.11 KiB)
- Physical/encoded ratio: `0.878x`
- Encoded/compressed-data ratio: `10.886x`
- Physical/compressed-data ratio: `9.563x`
- Physical/parquet-file ratio: `9.366x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-plain-str-plain-date-plain-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-plain-str-plain-date-plain-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-plain-date-plain-ts-rle-dict/part-00000.parquet`: `10000` rows, `823409` file bytes (804.11 KiB), `7711890` physical bytes (7.35 MiB), `8778991` encoded bytes (8.37 MiB), `806438` compressed data bytes (787.54 KiB)
