...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-snappy-int-plain-str-delta-byte-array-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4974816` (4.74 MiB)
- Compressed column data bytes after codec compression: `1092954` (1.04 MiB)
- Parquet file bytes: `1110121` (1.06 MiB)
- Physical/encoded ratio: `1.550x`
- Encoded/compressed-data ratio: `4.552x`
- Physical/compressed-data ratio: `7.056x`
- Physical/parquet-file ratio: `6.947x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-snappy-int-plain-str-delta-byte-array-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-snappy-int-plain-str-delta-byte-array-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-snappy-int-plain-str-delta-byte-array-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `1110121` file bytes (1.06 MiB), `7711890` physical bytes (7.35 MiB), `4974816` encoded bytes (4.74 MiB), `1092954` compressed data bytes (1.04 MiB)
