...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-snappy-int-rle-dict-str-plain-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `6009955` (5.73 MiB)
- Compressed column data bytes after codec compression: `1171658` (1.12 MiB)
- Parquet file bytes: `1189664` (1.13 MiB)
- Physical/encoded ratio: `1.283x`
- Encoded/compressed-data ratio: `5.129x`
- Physical/compressed-data ratio: `6.582x`
- Physical/parquet-file ratio: `6.482x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-snappy-int-rle-dict-str-plain-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-snappy-int-rle-dict-str-plain-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib-dictpage-1mib/10000_rows/parquet/rows-10000-comp-snappy-int-rle-dict-str-plain-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `1189664` file bytes (1.13 MiB), `7711890` physical bytes (7.35 MiB), `6009955` encoded bytes (5.73 MiB), `1171658` compressed data bytes (1.12 MiB)
