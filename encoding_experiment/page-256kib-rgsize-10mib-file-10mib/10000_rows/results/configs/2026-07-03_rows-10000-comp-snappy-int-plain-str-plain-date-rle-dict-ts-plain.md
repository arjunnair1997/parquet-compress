...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-snappy-int-plain-str-plain-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `8807000` (8.40 MiB)
- Compressed column data bytes after codec compression: `1272813` (1.21 MiB)
- Parquet file bytes: `1290031` (1.23 MiB)
- Physical/encoded ratio: `0.876x`
- Encoded/compressed-data ratio: `6.919x`
- Physical/compressed-data ratio: `6.059x`
- Physical/parquet-file ratio: `5.978x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-snappy-int-plain-str-plain-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-snappy-int-plain-str-plain-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-snappy-int-plain-str-plain-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `1290031` file bytes (1.23 MiB), `7711890` physical bytes (7.35 MiB), `8807000` encoded bytes (8.40 MiB), `1272813` compressed data bytes (1.21 MiB)
