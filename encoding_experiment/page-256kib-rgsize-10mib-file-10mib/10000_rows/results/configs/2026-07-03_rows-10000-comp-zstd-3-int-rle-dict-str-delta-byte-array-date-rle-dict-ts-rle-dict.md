...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `2109843` (2.01 MiB)
- Compressed column data bytes after codec compression: `882808` (862.12 KiB)
- Parquet file bytes: `900592` (879.48 KiB)
- Physical/encoded ratio: `3.655x`
- Encoded/compressed-data ratio: `2.390x`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-rle-dict/part-00000.parquet`: `10000` rows, `900592` file bytes (879.48 KiB), `7711890` physical bytes (7.35 MiB), `2109843` encoded bytes (2.01 MiB), `882808` compressed data bytes (862.12 KiB)
