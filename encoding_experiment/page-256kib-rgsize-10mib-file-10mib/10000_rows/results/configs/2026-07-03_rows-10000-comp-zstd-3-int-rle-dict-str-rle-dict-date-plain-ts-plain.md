...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `1745718` (1.66 MiB)
- Compressed column data bytes after codec compression: `706202` (689.65 KiB)
- Parquet file bytes: `723665` (706.70 KiB)
- Physical/encoded ratio: `4.418x`
- Encoded/compressed-data ratio: `2.472x`
- Physical/compressed-data ratio: `10.920x`
- Physical/parquet-file ratio: `10.657x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `723665` file bytes (706.70 KiB), `7711890` physical bytes (7.35 MiB), `1745718` encoded bytes (1.66 MiB), `706202` compressed data bytes (689.65 KiB)
