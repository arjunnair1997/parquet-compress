...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-none-int-rle-dict-str-plain-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `6049964` (5.77 MiB)
- Compressed column data bytes after codec compression: `6049964` (5.77 MiB)
- Parquet file bytes: `6068141` (5.79 MiB)
- Physical/encoded ratio: `1.275x`
- Encoded/compressed-data ratio: `1.000x`
- Physical/compressed-data ratio: `1.275x`
- Physical/parquet-file ratio: `1.271x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-none-int-rle-dict-str-plain-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-none-int-rle-dict-str-plain-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-none-int-rle-dict-str-plain-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `6068141` file bytes (5.79 MiB), `7711890` physical bytes (7.35 MiB), `6049964` encoded bytes (5.77 MiB), `6049964` compressed data bytes (5.77 MiB)
