...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-rle-dict-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `5942015` (5.67 MiB)
- Compressed column data bytes after codec compression: `876124` (855.59 KiB)
- Parquet file bytes: `893919` (872.97 KiB)
- Physical/encoded ratio: `1.298x`
- Encoded/compressed-data ratio: `6.782x`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-rle-dict-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-rle-dict-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-rle-dict-ts-rle-dict/part-00000.parquet`: `10000` rows, `893919` file bytes (872.97 KiB), `7711890` physical bytes (7.35 MiB), `5942015` encoded bytes (5.67 MiB), `876124` compressed data bytes (855.59 KiB)
