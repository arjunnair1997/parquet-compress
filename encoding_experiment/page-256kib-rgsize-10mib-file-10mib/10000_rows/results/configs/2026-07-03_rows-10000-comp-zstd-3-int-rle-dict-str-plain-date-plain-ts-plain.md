...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `6049924` (5.77 MiB)
- Compressed column data bytes after codec compression: `830525` (811.06 KiB)
- Parquet file bytes: `848272` (828.39 KiB)
- Physical/encoded ratio: `1.275x`
- Encoded/compressed-data ratio: `7.284x`
- Physical/compressed-data ratio: `9.286x`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `848272` file bytes (828.39 KiB), `7711890` physical bytes (7.35 MiB), `6049924` encoded bytes (5.77 MiB), `830525` compressed data bytes (811.06 KiB)
