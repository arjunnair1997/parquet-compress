...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-snappy-int-rle-dict-str-plain-date-plain-ts-plain`
- Rows: `10000`
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-snappy-int-rle-dict-str-plain-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `1191636` file bytes (1.14 MiB), `7711890` physical bytes (7.35 MiB), `6049931` encoded bytes (5.77 MiB), `1173639` compressed data bytes (1.12 MiB)
