...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-plain-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `8806950` (8.40 MiB)
- Compressed column data bytes after codec compression: `760879` (743.05 KiB)
- Parquet file bytes: `777824` (759.59 KiB)
- Physical/encoded ratio: `0.876x`
- Encoded/compressed-data ratio: `11.575x`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-plain-str-plain-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-plain-str-plain-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-plain-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `777824` file bytes (759.59 KiB), `7711890` physical bytes (7.35 MiB), `8806950` encoded bytes (8.40 MiB), `760879` compressed data bytes (743.05 KiB)
