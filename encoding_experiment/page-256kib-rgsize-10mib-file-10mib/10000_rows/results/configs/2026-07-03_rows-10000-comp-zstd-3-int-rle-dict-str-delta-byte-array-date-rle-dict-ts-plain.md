...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `2177777` (2.08 MiB)
- Compressed column data bytes after codec compression: `837229` (817.61 KiB)
- Parquet file bytes: `854976` (834.94 KiB)
- Physical/encoded ratio: `3.541x`
- Encoded/compressed-data ratio: `2.601x`
- Physical/compressed-data ratio: `9.211x`
- Physical/parquet-file ratio: `9.020x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `854976` file bytes (834.94 KiB), `7711890` physical bytes (7.35 MiB), `2177777` encoded bytes (2.08 MiB), `837229` compressed data bytes (817.61 KiB)
