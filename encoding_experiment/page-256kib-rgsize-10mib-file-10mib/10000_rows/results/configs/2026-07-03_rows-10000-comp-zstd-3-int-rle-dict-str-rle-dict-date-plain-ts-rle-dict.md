...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `1677784` (1.60 MiB)
- Compressed column data bytes after codec compression: `751781` (734.16 KiB)
- Parquet file bytes: `769281` (751.25 KiB)
- Physical/encoded ratio: `4.596x`
- Encoded/compressed-data ratio: `2.232x`
- Physical/compressed-data ratio: `10.258x`
- Physical/parquet-file ratio: `10.025x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-rle-dict-date-plain-ts-rle-dict/part-00000.parquet`: `10000` rows, `769281` file bytes (751.25 KiB), `7711890` physical bytes (7.35 MiB), `1677784` encoded bytes (1.60 MiB), `751781` compressed data bytes (734.16 KiB)
