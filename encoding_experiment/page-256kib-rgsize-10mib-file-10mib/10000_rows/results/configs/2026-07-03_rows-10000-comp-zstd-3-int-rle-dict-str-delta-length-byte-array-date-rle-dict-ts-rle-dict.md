...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-length-byte-array-date-rle-dict-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4908328` (4.68 MiB)
- Compressed column data bytes after codec compression: `910058` (888.73 KiB)
- Parquet file bytes: `927837` (906.09 KiB)
- Physical/encoded ratio: `1.571x`
- Encoded/compressed-data ratio: `5.393x`
- Physical/compressed-data ratio: `8.474x`
- Physical/parquet-file ratio: `8.312x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-length-byte-array-date-rle-dict-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-length-byte-array-date-rle-dict-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-length-byte-array-date-rle-dict-ts-rle-dict/part-00000.parquet`: `10000` rows, `927837` file bytes (906.09 KiB), `7711890` physical bytes (7.35 MiB), `4908328` encoded bytes (4.68 MiB), `910058` compressed data bytes (888.73 KiB)
