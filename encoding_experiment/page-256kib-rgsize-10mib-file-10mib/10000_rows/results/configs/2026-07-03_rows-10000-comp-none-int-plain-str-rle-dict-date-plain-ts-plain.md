...
- Started: `2026-07-03T14:42:10-04:00`
- Write elapsed: `112ms`
- Input: `data/clickbench/hits.tsv.gz`
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4542822` (4.33 MiB)
- Compressed column data bytes after codec compression: `4542822` (4.33 MiB)
- Parquet file bytes: `4560012` (4.35 MiB)
- Physical/encoded ratio: `1.698x`
- Encoded/compressed-data ratio: `1.000x`
- Physical/compressed-data ratio: `1.698x`
- Physical/parquet-file ratio: `1.691x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-none-int-plain-str-rle-dict-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `4560012` file bytes (4.35 MiB), `7711890` physical bytes (7.35 MiB), `4542822` encoded bytes (4.33 MiB), `4542822` compressed data bytes (4.33 MiB)
