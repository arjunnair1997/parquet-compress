...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4502744` (4.29 MiB)
- Compressed column data bytes after codec compression: `636556` (621.64 KiB)
- Parquet file bytes: `653217` (637.91 KiB)
- Physical/encoded ratio: `1.713x`
- Encoded/compressed-data ratio: `7.074x`
- Physical/compressed-data ratio: `12.115x`
- Physical/parquet-file ratio: `11.806x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-plain/part-00000.parquet`: `10000` rows, `653217` file bytes (637.91 KiB), `7711890` physical bytes (7.35 MiB), `4502744` encoded bytes (4.29 MiB), `636556` compressed data bytes (621.64 KiB)
