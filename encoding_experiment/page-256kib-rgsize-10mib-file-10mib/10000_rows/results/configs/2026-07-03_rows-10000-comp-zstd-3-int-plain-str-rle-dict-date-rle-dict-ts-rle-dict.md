...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `4434810` (4.23 MiB)
- Compressed column data bytes after codec compression: `682135` (666.15 KiB)
- Parquet file bytes: `698833` (682.45 KiB)
- Physical/encoded ratio: `1.739x`
- Encoded/compressed-data ratio: `6.501x`
- Physical/compressed-data ratio: `11.306x`
- Physical/parquet-file ratio: `11.035x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-plain-str-rle-dict-date-rle-dict-ts-rle-dict/part-00000.parquet`: `10000` rows, `698833` file bytes (682.45 KiB), `7711890` physical bytes (7.35 MiB), `4434810` encoded bytes (4.23 MiB), `682135` compressed data bytes (666.15 KiB)
