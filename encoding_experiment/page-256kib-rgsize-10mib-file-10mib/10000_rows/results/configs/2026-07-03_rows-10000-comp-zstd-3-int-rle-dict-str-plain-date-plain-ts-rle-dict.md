...
- Started: `2026-07-03T14:42:15-04:00`
- Write elapsed: `170ms`
- Input: `data/clickbench/hits.tsv.gz`
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-rle-dict`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `5981990` (5.70 MiB)
- Compressed column data bytes after codec compression: `876104` (855.57 KiB)
- Parquet file bytes: `893888` (872.94 KiB)
- Physical/encoded ratio: `1.289x`
- Encoded/compressed-data ratio: `6.828x`
- Physical/compressed-data ratio: `8.802x`
- Physical/parquet-file ratio: `8.627x`
- Files: `1`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-rle-dict_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-rle-dict_columns.tsv)
...
| `Title` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:9` | `10000` | `2200605` (2.10 MiB) | `2247280` (2.14 MiB) | `232596` (227.14 KiB) | `0.979x` | `9.662x` | `9.461x` | `2200673` (2.10 MiB) |
...
| `URL` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:4` | `10000` | `760012` (742.20 KiB) | `800511` (781.75 KiB) | `90486` (88.37 KiB) | `0.949x` | `8.847x` | `8.399x` | `760022` (742.21 KiB) |
| `Referer` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:4` | `10000` | `797798` (779.10 KiB) | `838448` (818.80 KiB) | `101845` (99.46 KiB) | `0.952x` | `8.233x` | `7.833x` | `797822` (779.12 KiB) |
...
| `FlashMinor2` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `37170` (36.30 KiB) | `77229` (75.42 KiB) | `2686` (2.62 KiB) | `0.481x` | `28.752x` | `13.838x` | `37170` (36.30 KiB) |
...
| `UserAgentMinor` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `36930` (36.06 KiB) | `76989` (75.18 KiB) | `1802` (1.76 KiB) | `0.480x` | `42.724x` | `20.494x` | `37108` (36.24 KiB) |
...
| `MobilePhoneModel` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `1140` (1.11 KiB) | `41195` (40.23 KiB) | `242` (242 B) | `0.028x` | `170.227x` | `4.711x` | `1140` (1.11 KiB) |
| `Params` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `0` (0 B) | `40037` (39.10 KiB) | `48` (48 B) | `0.000x` | `834.104x` | `0.000x` | `0` (0 B) |
...
| `SearchPhrase` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `65246` (63.72 KiB) | `105322` (102.85 KiB) | `12844` (12.54 KiB) | `0.619x` | `8.200x` | `5.080x` | `65250` (63.72 KiB) |
...
| `PageCharset` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `196540` (191.93 KiB) | `236627` (231.08 KiB) | `386` (386 B) | `0.831x` | `613.023x` | `509.171x` | `196540` (191.93 KiB) |
...
| `OriginalURL` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `74750` (73.00 KiB) | `115520` (112.81 KiB) | `9582` (9.36 KiB) | `0.647x` | `12.056x` | `7.801x` | `74750` (73.00 KiB) |
...
| `HitColor` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `10000` (9.77 KiB) | `50051` (48.88 KiB) | `126` (126 B) | `0.200x` | `397.230x` | `79.365x` | `10000` (9.77 KiB) |
...
| `BrowserLanguage` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `20156` (19.68 KiB) | `60213` (58.80 KiB) | `402` (402 B) | `0.335x` | `149.784x` | `50.139x` | `20156` (19.68 KiB) |
| `BrowserCountry` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `32430` (31.67 KiB) | `72489` (70.79 KiB) | `1131` (1.10 KiB) | `0.447x` | `64.093x` | `28.674x` | `38645` (37.74 KiB) |
| `SocialNetwork` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `0` (0 B) | `40037` (39.10 KiB) | `48` (48 B) | `0.000x` | `834.104x` | `0.000x` | `0` (0 B) |
| `SocialAction` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `0` (0 B) | `40037` (39.10 KiB) | `48` (48 B) | `0.000x` | `834.104x` | `0.000x` | `0` (0 B) |
...
| `SocialSourcePage` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `42` (42 B) | `40102` (39.16 KiB) | `98` (98 B) | `0.001x` | `409.204x` | `0.429x` | `42` (42 B) |
...
| `ParamOrderID` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `0` (0 B) | `40037` (39.10 KiB) | `48` (48 B) | `0.000x` | `834.104x` | `0.000x` | `0` (0 B) |
| `ParamCurrency` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `30000` (29.30 KiB) | `70058` (68.42 KiB) | `86` (86 B) | `0.428x` | `814.628x` | `348.837x` | `30000` (29.30 KiB) |
...
| `OpenstatServiceName` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `560` (560 B) | `40639` (39.69 KiB) | `239` (239 B) | `0.014x` | `170.038x` | `2.343x` | `560` (560 B) |
| `OpenstatCampaignID` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `272` (272 B) | `40339` (39.39 KiB) | `239` (239 B) | `0.007x` | `168.782x` | `1.138x` | `272` (272 B) |
| `OpenstatAdID` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `358` (358 B) | `40425` (39.48 KiB) | `297` (297 B) | `0.009x` | `136.111x` | `1.205x` | `358` (358 B) |
| `OpenstatSourceID` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `692` (692 B) | `40775` (39.82 KiB) | `267` (267 B) | `0.017x` | `152.715x` | `2.592x` | `692` (692 B) |
| `UTMSource` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `1621` (1.58 KiB) | `41688` (40.71 KiB) | `500` (500 B) | `0.039x` | `83.376x` | `3.242x` | `1621` (1.58 KiB) |
| `UTMMedium` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `502` (502 B) | `40557` (39.61 KiB) | `414` (414 B) | `0.012x` | `97.964x` | `1.213x` | `502` (502 B) |
| `UTMCampaign` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `3304` (3.23 KiB) | `43419` (42.40 KiB) | `630` (630 B) | `0.076x` | `68.919x` | `5.244x` | `3304` (3.23 KiB) |
| `UTMContent` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `474` (474 B) | `40533` (39.58 KiB) | `264` (264 B) | `0.012x` | `153.534x` | `1.795x` | `474` (474 B) |
| `UTMTerm` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `1288` (1.26 KiB) | `41367` (40.40 KiB) | `327` (327 B) | `0.031x` | `126.505x` | `3.939x` | `1288` (1.26 KiB) |
| `FromTag` | `string` | `plain` | `PLAIN` | `DATA_PAGE_V2/PLAIN:1` | `10000` | `0` (0 B) | `40037` (39.10 KiB) | `48` (48 B) | `0.000x` | `834.104x` | `0.000x` | `0` (0 B) |
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-plain-date-plain-ts-rle-dict/part-00000.parquet`: `10000` rows, `893888` file bytes (872.94 KiB), `7711890` physical bytes (7.35 MiB), `5981990` encoded bytes (5.70 MiB), `876104` compressed data bytes (855.57 KiB)
