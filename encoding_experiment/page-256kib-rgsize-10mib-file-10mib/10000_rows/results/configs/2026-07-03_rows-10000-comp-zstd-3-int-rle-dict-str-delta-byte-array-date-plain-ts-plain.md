...
- Output directory: `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-plain-ts-plain`
- Rows: `10000`
- Source TSV bytes for rows, reference only: `8365486` (7.98 MiB)
- Parquet physical bytes before page encoding: `7711890` (7.35 MiB)
- Encoded column bytes before codec compression: `2217752` (2.12 MiB)
- Compressed column data bytes after codec compression: `837209` (817.59 KiB)
- Parquet file bytes: `854945` (834.91 KiB)
- Physical/encoded ratio: `3.477x`
- Encoded/compressed-data ratio: `2.649x`
...
Column stats TSV: [2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-plain-ts-plain_columns.tsv](../../tsvs/2026-07-03_rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-plain-ts-plain_columns.tsv)
...
- `encoding_experiment/page-256kib-rgsize-10mib-file-10mib/10000_rows/parquet/rows-10000-comp-zstd-3-int-rle-dict-str-delta-byte-array-date-plain-ts-plain/part-00000.parquet`: `10000` rows, `854945` file bytes (834.91 KiB), `7711890` physical bytes (7.35 MiB), `2217752` encoded bytes (2.12 MiB), `837209` compressed data bytes (817.59 KiB)
